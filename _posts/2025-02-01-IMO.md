...
tags: Machine-Learning Detectability MCB shipping-sulfur-regulation
themes: [boundary-layer-clouds, climate-engineering, energy-imbalance]
#categories: research
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/IMO_poster_web.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
